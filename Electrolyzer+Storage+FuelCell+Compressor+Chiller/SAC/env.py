...
class HydrogenEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.storage = CascadeStorage()  # 重置到初始 SOC
    ...
    def step(self, action):
        ...
        penalty = 0
        if shortage_h2 > 0: penalty += shortage_h2 * Config.penalty_unmet_demand
        if excess_h2 > 0: penalty += excess_h2 * 10
